...
const SUGGESTIONS = [
  {
    icon: BarChart3Icon,
    label: "Top Products",
    prompt: "What were my best performing products last month?",
  },
  {
    icon: ClockIcon,
    label: "Peak Hours",
    prompt: "Which hours of the day have the highest sales?",
  },
  {
    icon: LineChartIcon,
    label: "Order Value",
    prompt: "How can I improve my average order value?",
  },
  {
    icon: ActivityIcon,
    label: "Underperformers",
    prompt: "What products are underperforming and should I consider removing?",
  },
  {
    icon: TrendingUpIcon,
    label: "Sales Forecast",
    prompt: "Give me a weekly sales summary and forecast.",
  },
  {
    icon: UsersIcon,
    label: "Customer Retention",
    prompt: "What is my customer retention rate this quarter?",
  },
];
...
export default function StoreAnalyticsPage() {
  ...
  const { messages, sendMessage, status, stop } = useChat({
    transport: new DefaultChatTransport({
      api: `${API_URL}/ai-integration/chat/analytics`,
        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            <Textarea
              ...
              placeholder="Ask about your sales, products, trends, or KPIs…"
  ...
  return (
    <div className="flex flex-col items-center text-center pt-10 pb-6">
      ...
      <h2 className="text-xl font-semibold text-foreground tracking-tight text-balance">
        Store Performance Assistant
      </h2>
      <p className="mt-2 max-w-sm text-sm text-muted-foreground leading-relaxed text-pretty">
        Ask about your store performance, get sales insights, identify trends,
        and receive actionable recommendations to grow your business.
      </p>
