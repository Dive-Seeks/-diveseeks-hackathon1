...
export default function ResearchProjectChatPage() {
  const { messages, send, isLoading, historyLoaded, activeSessionId, toggleExpanded } = useWorkflowChat("research");
  ...
  return (
    <div className="flex h-[calc(100vh-var(--header-height))] w-full overflow-hidden bg-background">
      <div className="w-[30%] min-w-[280px] max-w-[400px] shrink-0 border-r border-border/40 overflow-hidden">
        <ProjectChatSidebar team="research" />
      </div>
