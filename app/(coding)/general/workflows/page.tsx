...
export default function GeneralWorkflowsPage() {
  return (
    <div className="flex-1 flex flex-col p-6 space-y-6 max-w-7xl mx-auto w-full animate-in fade-in duration-300">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Select a project to open its chat canvas and work with your General Team.
        </p>
      </div>

      <WorkflowsProjectTable team="general" />
    </div>
  );
}
