...
import { FileText, Pencil, Search, FolderPlusIcon, ArrowRightIcon } from "lucide-react";
...
const SUGGESTIONS = [
  { label: "Create a plan", icon: FileText },
...
export default function CodingDashboardPage() {
  ...
  const activeProject = useCodingStore((s) => s.activeProjects["coding"]);

  return (
    <ChatCanvas
      greeting="What's on the agenda today?"
      subtitle="Abigail is ready to assist with your next technical goal."
